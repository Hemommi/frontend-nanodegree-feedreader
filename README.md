...
1.	RSS Feeds – first test. It tests to make sure that the allFeeds variable has been defined and  it’s not empty.
...
4.	Test suite – New Feed Selection. Test ensures when a new feed is loaded by the loadFeed function that the content changes. Test requires the use of Jasmine’s afterEach function. 
